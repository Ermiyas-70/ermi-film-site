...
const APILINK = 'https://ermi-film-site-kmfd.vercel.app/';
...
// 1. Create New Review Input Card
const div_new = document.createElement('div');
div_new.innerHTML = `
  <div class="card">
    <h4>New Review</h4>
    <p><strong>Review:</strong></p>
    <p><input type="text" id="new_review" value=""></p>
    <p><strong>User:</strong></p>
    <p><input type="text" id="new_user" value=""></p>
...
function editReview(id, review, user) {
  ...
  element.innerHTML = `
    <p><strong>Review:</strong></p>
    <p><input type="text" id="${reviewInputId}" value="${review}"></p>
    <p><strong>User:</strong></p>
    <p><input type="text" id="${userInputId}" value="${user}"></p>
